 ...
 */
final class Version20240615054302 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE team DROP team_lead');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE team ADD team_lead INT NOT NULL');
